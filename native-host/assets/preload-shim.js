...
(function () {
  ...
  const api = {
    ...
    browserDevtools: function (open, activeUrl) { return invoke("browser:devtools", open, activeUrl); },
    ...
    remoteGet: function () { return invoke("remote:get"); },
    remoteSet: function (config) { return invoke("remote:set", config); },
    ...
    updateDownload: function (url) { return invoke("update:download", url); },
    updateInstall: function (path) { return invoke("update:install", path); },
